...
This repository contains the `@boredkevin/ui` component library. All agentic AI assistants must follow the guidelines established in `ai-skill/SKILL.md` and `ai-skill/design.json`.
...
3. **Strict Props & Variants**: Consult `ai-skill/components/*.meta.ts` for valid variants and properties.
